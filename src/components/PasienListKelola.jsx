...
const PasienListKelola = () => {
  ...
  const fetchRecords = () => {
    axios
      .get("http://localhost:9999/api/users/findAllPemeriksaanByIdPelayanan")
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:9999/api/users/findAllPasien")
      .then((response) => {
    ...
    axios
      .get("http://localhost:9999/api/users/findAllDokterByIdPelayanan")
      .then((response) => {
  ...
  const handleFormSubmit = (e) => {
    ...
    axios
      .post("http://localhost:9999/api/users/addPemeriksaan", updatedRecord)
      .then((response) => {
