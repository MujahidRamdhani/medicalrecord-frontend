...
const FormProfile = () => {
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      const response = await axios.put("http://localhost:9999/api/users/updateProfile", updatedData);
  ...
  const handleChangePassword = async () => {
    ...
    setLoading(true);
    try {
      const response = await axios.put('http://localhost:9999/api/users/changePassword', {
        newPassword,
      });
